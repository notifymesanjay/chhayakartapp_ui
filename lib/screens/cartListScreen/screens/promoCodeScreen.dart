                ...
                builder: (context, promoCodeProvider, _) {
                  return promoCodeProvider.promoCodeState == PromoCodeState.loading
                      ...
                      : promoCodeProvider.promoCodeState == PromoCodeState.loaded
                          ? Column(
                              children: List.generate(promoCodeProvider.promoCode.data.length, (index) => promoCodeItemWidget(promoCodeProvider.promoCode.data[index])),
                            )
                          : DefaultBlankItemMessageScreen(
                              image: "blank_promo_code",
                              title: "Oops!",
      ...
      child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                promoCode.isApplicable == 0 ? promoCode.message : "You will save ${GeneralMethods.getCurrencyFormat(double.parse(promoCode.discount))} on this coupon",
                softWrap: true,
                style: TextStyle(color: promoCode.isApplicable == 0 ? ColorsRes.appColorRed : ColorsRes.subTitleMainTextColor),
              ),
              ...
              Row(
                children: [
                  Expanded(
                    flex: 2,
                    child: Padding(padding: EdgeInsetsDirectional.only(end: Constant.size12), child: promoCodeWidget(promoCode.promoCode, promoCode.isApplicable == 0 ? ColorsRes.grey : ColorsRes.appColor)),
                  ),
                  const Spacer(),
                  Expanded(
                    flex: 1,
                    child: GestureDetector(
                      onTap: () {
                        if (promoCode.isApplicable == 1 && Constant.selectedCoupon != promoCode.promoCode) {
                      ...
                      child: Constant.selectedCoupon != promoCode.promoCode
                          ? Container(
                              ...
                              decoration: DesignConfig.boxDecoration(promoCode.isApplicable == 0 ? ColorsRes.grey.withOpacity(0.2) : ColorsRes.appColorLightHalfTransparent, 5, bordercolor: promoCode.isApplicable == 0 ? ColorsRes.grey : ColorsRes.appColor, isboarder: true, borderwidth: 1),
                              child: Center(
                                child: Text(
                                    getTranslatedValue(
                                      context,
                                    ...
                                    style: Theme.of(context).textTheme.labelSmall?.copyWith(color: promoCode.isApplicable == 0 ? ColorsRes.grey : ColorsRes.appColor)),
                              ),
                            )
                          : Center(
                              child: Text(
                                  ...
                                  style: Theme.of(context).textTheme.labelSmall?.copyWith(fontSize: 13, color: ColorsRes.appColor)),
                            ),
                    ),
                  )
                ],
            ...
            child: Stack(
              ...
              children: [
                Container(
                  ...
                  height: 30,
                  decoration: DesignConfig.boxDecoration(color.withOpacity(0.2), 7),
                  child: DashedRect(
                    color: color,
                    strokeWidth: 1.0,
                    gap: 10,
