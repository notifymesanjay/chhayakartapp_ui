...
class ProductVariantDropDownMenuList extends StatefulWidget {
  ...
  @override
  State<ProductVariantDropDownMenuList> createState() => _ProductVariantDropDownMenuListState();
}

class _ProductVariantDropDownMenuListState extends State<ProductVariantDropDownMenuList> {
  @override
                ...
                children: [
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          double.parse(widget.variants[selectedVariantItemProvider.getSelectedIndex()].discountedPrice) != 0 ? GeneralMethods.getCurrencyFormat(double.parse(widget.variants[selectedVariantItemProvider.getSelectedIndex()].discountedPrice)) : GeneralMethods.getCurrencyFormat(double.parse(widget.variants[selectedVariantItemProvider.getSelectedIndex()].price)),
                          softWrap: true,
                    ...
                    children: [
                      Expanded(
                        child: GestureDetector(
                          ...
                          child: Container(
                            margin: widget.isGrid ? EdgeInsets.zero : EdgeInsetsDirectional.only(end: 10),
